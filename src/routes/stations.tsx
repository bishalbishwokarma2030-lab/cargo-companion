    ...
    <div>
      <PageHeader
        ...
        actions={
          <>
            ...
            <Button onClick={openCreate} className="bg-gradient-primary"><Plus className="mr-1 h-4 w-4" />Create</Button>
          </>
        }
      />
      <div className="p-6">
        ...
        <DataTable<Station>
          ...
          columns={[
            ...
            { key: "created_at", header: "Created", render: (r) => <span className="text-xs text-muted-foreground">{new Date(r.created_at).toLocaleString()}</span> },
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-w-xl">
          ...
          <DialogFooter><Button variant="outline" onClick={() => setOpen(false)}>Cancel</Button><Button onClick={save} className="bg-gradient-primary">Save</Button></DialogFooter>
        </DialogContent>
      </Dialog>
